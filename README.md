...
| <img src="./ios-simulator/assets/icon.png" width="22" alt=""> | iOS Simulator | [`ios-simulator`](./ios-simulator) | Host-owned embedded iOS Simulator workflow, with Host-authorized external fallback; staged rollout |
